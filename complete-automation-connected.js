...
/**
 * 🚀 COMPLETE AUTOMATION - business@cryptorafts.com (Hostinger) Connected to cryptorafts@gmail.com
 * All emails will be sent from business@cryptorafts.com using Gmail SMTP
 */

import nodemailer from 'nodemailer';

console.log('🚀 CryptoRafts Complete Automation');
console.log('business@cryptorafts.com (Hostinger) → cryptorafts@gmail.com (Gmail)');
console.log('====================================================================\n');

// Complete automated email service
class CompleteAutomation {
  constructor() {
    // Use cryptorafts@gmail.com for SMTP, but send from business@cryptorafts.com
    this.config = {
      host: 'smtp.gmail.com',
      port: 587,
      secure: false,
      auth: {
        user: 'cryptorafts@gmail.com', // Use your existing Gmail for SMTP
  ...
  async sendEmail(userData) {
    try {
      ...
      console.log('✅ Gmail connection successful (cryptorafts@gmail.com)!');
  ...
  async testCompleteAutomation() {
    ...
    if (result) {
      console.log('\n🎉 SUCCESS! Complete automation working!');
      console.log('📧 Professional CryptoRafts approval email sent!');
      console.log('📧 All emails will be sent FROM: business@cryptorafts.com');
      console.log('\n📋 Next Steps:');
      console.log('1. Get Gmail App Password for cryptorafts@gmail.com');
...
automation.testCompleteAutomation();
