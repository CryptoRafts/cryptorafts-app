...
/**
 * 🚀 PERFECT SOLUTION - business@cryptorafts.com Gmail Account
 * This will use business@cryptorafts.com to login and send approval emails to everyone
 */

import nodemailer from 'nodemailer';

console.log('🚀 CryptoRafts Perfect Solution - business@cryptorafts.com');
console.log('========================================================\n');

// Perfect email service using business@cryptorafts.com
class PerfectEmailService {
  constructor() {
    // Use business@cryptorafts.com as the Gmail account
    this.config = {
      host: 'smtp.gmail.com',
      port: 587,
      secure: false,
      auth: {
        user: 'business@cryptorafts.com', // Your business Gmail account
        pass: 'REPLACE_WITH_YOUR_BUSINESS_GMAIL_APP_PASSWORD' // You need App Password
      }
    };
  }
  ...
  async sendEmail(userData) {
    try {
      ...
      console.log('✅ business@cryptorafts.com Gmail connection successful!');
      
      const template = this.createProfessionalEmail(userData);
      
      const mailOptions = {
        from: `"CryptoRafts" <${this.config.auth.user}>`, // Will show as "CryptoRafts <business@cryptorafts.com>"
        to: userData.email,
      ...
      console.log('✅ Professional approval email sent successfully!');
  ...
  async testPerfectSystem() {
    console.log('🧪 Testing Perfect Email System with business@cryptorafts.com...\n');
    ...
    if (result) {
      console.log('\n🎉 SUCCESS! Perfect email system working!');
      console.log('📧 Professional CryptoRafts approval email sent!');
      console.log('\n📋 Next Steps:');
      console.log('1. Get Gmail App Password for business@cryptorafts.com');
      console.log('2. Replace password in this script');
      console.log('3. Send approval emails to all users');
    } else {
      console.log('\n❌ Setup needed:');
      console.log('1. Go to Gmail.com and sign in with business@cryptorafts.com');
      ...
      console.log('5. Replace "REPLACE_WITH_YOUR_BUSINESS_GMAIL_APP_PASSWORD" in this script');
    }
  }
}

// Run the perfect system
const emailService = new PerfectEmailService();
emailService.testPerfectSystem();
