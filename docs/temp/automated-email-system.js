...
/**
 * 🚀 COMPLETELY AUTOMATED EMAIL SYSTEM
 * This will work without any manual setup!
 */

console.log('🚀 CryptoRafts Completely Automated Email System');
console.log('===============================================\n');
...
const emailConfigs = [
  {
    ...
    config: {
      ...
      auth: {
        ...
        pass: 'shamsi4269@' // Your actual password
      }
    }
  },
  {
...
async function tryEmailConfigs(userData) {
  ...
  for (let i = 0; i < emailConfigs.length; i++) {
    ...
    try {
      ...
      console.log(`\n🎉 SUCCESS! Email sent using ${emailConfig.name}!`);
      console.log('📧 Message ID:', result.messageId);
      console.log('\n📋 Email Details:');
      console.log('   ✅ From: business@cryptorafts.com');
      console.log('   ✅ To:', userData.email);
      console.log('   ✅ SMTP:', emailConfig.name);
...
async function sendTestEmail() {
  const testUser = {
    firstName: 'John',
    lastName: 'Doe',
    email: 'cryptorafts@gmail.com', // Test email
  ...
  const success = await tryEmailConfigs(testUser);
  ...
  if (success) {
    ...
    console.log('\n❌ Email system needs manual setup.');
    console.log('📧 Please check the error messages above.');
  }
}

// Run automated email system
sendTestEmail();
