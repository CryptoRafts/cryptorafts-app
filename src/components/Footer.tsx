      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <h3 className="text-2xl font-bold text-white mb-4">Cryptorafts</h3>
            <p className="text-white/70 mb-6 max-w-md">
              The premier platform connecting crypto founders, investors, and innovators worldwide. 
              AI-verified deal flow on chain with KYC/KYB, due diligence, and secure deal rooms.
            </p>
