...
export default function FounderDashboardEnhanced() {
      ...
      const cards: DashboardCard[] = [
        {
          ...
          icon: <NeonCyanIcon type="rocket" size={24} className="text-current" />,
        ...
        },
        {
          ...
          icon: <NeonCyanIcon type="dollar" size={24} className="text-current" />,
        ...
        },
        {
          ...
          value: realtimeStats.dealRooms,
          change: realtimeStats.dealRooms > 0 ? `+${realtimeStats.dealRooms}` : undefined,
          icon: <NeonCyanIcon type="chat" size={24} className="text-current" />,
        ...
        },
        {
          ...
          change: '+12%',
          icon: <NeonCyanIcon type="eye" size={24} className="text-current" />,
    ...
    const insights: AIInsight[] = [
      {
        ...
        icon: <NeonCyanIcon type="star" size={20} className="text-current" />,
        timestamp: new Date()
      },
      {
        id: '2',
        ...
        icon: <NeonCyanIcon type="lightbulb" size={20} className="text-current" />,
      ...
      },
      {
        ...
        icon: <NeonCyanIcon type="chart" size={20} className="text-current" />,
        timestamp: new Date()
      }
    ];
  ...
  const startLiveMetrics = useCallback(() => {
    ...
    const updateMetricsFromFirebase = () => {
      ...
      Promise.all([
        // Get pitches count
        getDocs(query(collection(dbInstance, 'pitches'), where('founderId', '==', user.uid))).then(snap => snap.size),
        // Get chat rooms count
        getDocs(query(collection(dbInstance, 'chatRooms'), where('participants', 'array-contains', user.uid))).then(snap => snap.size),
        // Get notifications count
        getDocs(query(collection(dbInstance, 'notifications'), where('userId', '==', user.uid))).then(snap => snap.size),
        // Get projects count
        getDocs(query(collection(dbInstance, 'projects'), where('founderId', '==', user.uid))).then(snap => snap.size)
  ...
  const getBadgeIcon = (type: string) => {
    switch (type) {
      case 'kyc': return <NeonCyanIcon type="shield" size={16} className="text-current" />;
      case 'kyb': return <NeonCyanIcon type="building" size={16} className="text-current" />;
      case 'audit': return <NeonCyanIcon type="document" size={16} className="text-current" />;
      case 'doxxed': return <NeonCyanIcon type="users" size={16} className="text-current" />;
      default: return null;
    }
  };
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-blue-900 to-purple-900 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 py-8 relative z-10">
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xl text-gray-300">
                  Welcome back, {profile?.displayName || user.displayName || 'Founder'}
              </p>
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="relative">
                ...
                <NeonCyanIcon type="bell" size={24} className="text-white" />
              </button>
              ...
              >
                <NeonCyanIcon type="settings" size={24} className="text-white" />
              </button>
            </div>
          </div>
        </div>
          ...
          <div className="mb-8 bg-white/5 backdrop-blur-xl rounded-2xl border border-white/10 p-6">
            <div className="flex items-center justify-between mb-4">
              <h3 className="text-lg font-semibold text-white flex items-center space-x-2">
                <NeonCyanIcon type="analytics" size={20} className="text-green-400" />
        ...
        <div className="mb-8 bg-gradient-to-r from-green-500/10 to-blue-500/10 backdrop-blur-xl rounded-2xl border border-green-500/20 p-6">
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-lg font-semibold text-white flex items-center space-x-2">
              <NeonCyanIcon type="bolt" size={20} className="text-green-400" />
              ...
              <div className="flex items-center justify-between mb-4">
                ...
                {card.change && (
                  <span className="text-green-400 text-sm font-medium flex items-center animate-pulse">
                    <NeonCyanIcon type="arrow-up" size={16} className="text-current mr-1" />
                    {card.change}
                  </span>
                )}
              </div>
            ...
            <div className="bg-white/5 backdrop-blur-xl rounded-2xl border border-white/10 p-6">
              ...
              {projects.length > 0 ? (
                ...
                <div className="text-center py-12">
                  <NeonCyanIcon type="rocket" size={64} className="text-gray-400 mx-auto mb-4" />
            ...
            {pitch?.aiDecision && (
              <div className="bg-white/5 backdrop-blur-xl rounded-2xl border border-white/10 p-6">
                <h3 className="text-lg font-semibold text-white mb-4 flex items-center space-x-2">
                  <NeonCyanIcon type="cpu" size={20} className="text-blue-400" />
                      ...
                      <div className="flex space-x-1">
                        {[...Array(5)].map((_, i) => (
                          <NeonCyanIcon type="star" 
                            key={i} 
                            size={16}
                            className={`${i < Math.floor(pitch.aiDecision.confidence * 5) ? 'text-yellow-400' : 'text-gray-600'}`} 
                          />
                        ))}
                      </div>
                    </p>
            ...
            <div className="bg-white/5 backdrop-blur-xl rounded-2xl border border-white/10 p-6">
              ...
              {chatRooms.length > 0 ? (
                ...
                <div className="text-center py-8">
                  <NeonCyanIcon type="chat" size={48} className="text-gray-400 mx-auto mb-3" />
            ...
            <div className="bg-white/5 backdrop-blur-xl rounded-2xl border border-white/10 p-6">
              ...
              <div className="space-y-3">
                ...
                >
                  ...
                  <NeonCyanIcon type="sparkles" size={16} className="text-blue-400 ml-auto" />
                </button>
                <button
