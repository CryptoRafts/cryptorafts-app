...
export default function AgencyKYB() {
    ...
    switch (kybStatus) {
      ...
      case 'verified':
        return {
          ...
          title: "KYB Verified",
          description: "Your marketing agency has been successfully verified.",
      ...
      case 'pending':
        return {
          ...
          title: "KYB Pending",
          description: "Your marketing agency verification is being reviewed.",
      ...
      case 'rejected':
        return {
          ...
          title: "KYB Rejected",
          description: "Your marketing agency verification was rejected. Please try again.",
          color: "text-red-400",
      ...
      default:
        return {
          ...
          title: "KYB Required",
          description: "Complete marketing agency verification to access all features.",
          color: "text-blue-400",
        ...
        <div className="w-full max-w-4xl">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-white/70 text-lg max-w-2xl mx-auto">
              Complete your KYB verification to unlock all marketing agency features and access the full platform
            </p>
          </div>

          {/* Main Card */}
          <div className="bg-black/70 backdrop-blur-lg border border-white/20 rounded-3xl shadow-2xl p-8 md:p-12">
            {/* Status Display */}
            ...
            <div className="bg-gradient-to-r from-blue-500/10 to-blue-500/10 border border-blue-500/30 rounded-2xl p-6 mb-8">
              <div className="flex items-start space-x-4">
                ...
                <div className="flex-1">
                  <h3 className="text-xl font-bold text-white mb-2">AI-Powered Agency Verification</h3>
                  <p className="text-white/70 mb-4">
                    Our AI system verifies your marketing agency information in real-time with advanced company data validation.
                  </p>
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div className="flex items-center space-x-2">
                      <NeonCyanIcon type="check" className="text-green-400" size={20} />
                      <span className="text-white/80 text-sm">Agency Validation</span>
                    </div>
                    <div className="flex items-center space-x-2">
                      <NeonCyanIcon type="check" className="text-green-400" size={20} />
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <input
                      ...
                      placeholder="Enter your marketing agency name"
                    />
                  </div>
            ...
            <div className="mt-8 text-center">
              <p className="text-white/50 text-sm">
                Your marketing agency information is encrypted and secure. We never share your data with third parties.
              </p>
            </div>
          </div>
        </div>
