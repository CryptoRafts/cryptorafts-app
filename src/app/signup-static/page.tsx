        ...
        <div className="bg-black/90 backdrop-blur-sm rounded-2xl p-6 sm:p-8 border border-gray-700 shadow-2xl">
          ...
          <div className="mt-4 text-center space-y-2">
            ...
            <div className="flex gap-2 justify-center text-xs">
              <Link href="/signup" className="text-blue-400 hover:text-blue-300">Main</Link>
              <Link href="/signup-simple" className="text-blue-400 hover:text-blue-300">Simple</Link>
              <Link href="/signup-test" className="text-blue-400 hover:text-blue-300">Test</Link>
            </div>
          </div>
        </div>
      </div>
