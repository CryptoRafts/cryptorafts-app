...
export default function ExchangeKYBWaitingSimple() {
    ...
    if (!isLoading && user) {
      const setupListener = async () => {
        ...
        const isReady = await waitForFirebase(3000);
          ...
          const unsubscribe = onSnapshot(doc(dbInstance, 'users', user.uid), (doc) => {
            if (doc.exists()) {
            ...
            setLoading(false);
          }, createSnapshotErrorHandler('exchange kyb waiting'));
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-blue-900 to-blue-900 flex items-center justify-center p-4">
      <div className="bg-gray-800/50 backdrop-blur-lg rounded-3xl shadow-2xl p-8 md:p-12 max-w-2xl w-full text-center border border-gray-700">
        ...
        <h1 className="text-4xl font-extrabold text-white mb-4">
          Exchange KYB Under Review
        </h1>
        
        <p className="text-lg text-gray-300 mb-8">
          Your exchange verification is being reviewed by our team. This usually takes 1-3 business days.
        </p>
        ...
        <div className="bg-gray-700/30 border border-gray-600 rounded-xl p-6 mb-8">
          <div className="flex items-start space-x-4">
            <div className="w-8 h-8 text-cyan-400 text-2xl">✨</div>
            <div className="text-left">
              <h3 className="text-xl font-semibold text-white mb-2">
                What happens next?
              </h3>
              <ul className="text-gray-300 text-sm space-y-2">
                <li>• Our team reviews your exchange information</li>
