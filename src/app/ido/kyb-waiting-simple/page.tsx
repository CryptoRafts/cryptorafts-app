...
export default function IDOKYBWaitingSimple() {
      ...
      const setupListener = async () => {
        try {
          ...
          const unsubscribe = onSnapshot(doc(dbInstance, 'users', user.uid), (doc) => {
            ...
            setLoading(false);
          }, createSnapshotErrorHandler('IDO kyb waiting'));
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-blue-900 to-blue-900 flex items-center justify-center p-4">
      <div className="bg-gray-800/50 backdrop-blur-lg rounded-3xl shadow-2xl p-8 md:p-12 max-w-2xl w-full text-center border border-gray-700">
        ...
        <h1 className="text-4xl font-extrabold text-white mb-4">
          IDO Platform KYB Under Review
        </h1>
        
        <p className="text-lg text-gray-300 mb-8">
          Your IDO platform verification is being reviewed by our team. This usually takes 1-3 business days.
        </p>
          ...
          <div className="flex items-start space-x-4">
            ...
            <div className="text-left">
              ...
              <ul className="text-gray-300 text-sm space-y-2">
                <li>• Our team reviews your IDO platform information</li>
