...
export default function IDORegister() {
  ...
  useEffect(() => {
    ...
    if (userRole && userRole !== 'ido') {
      console.log("❌ User role mismatch. Expected: ido, Got:", userRole);
      router.push('/role');
      return;
    }
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.log('💾 Saving IDO registration data...');
      ...
      await safeFirebaseOperation(
        ...
        'IDO Registration Save',
        5 // 5 retries
      );
      
      console.log('✅ IDO registration complete!');
      ...
      <div className="max-w-2xl mx-auto px-4 sm:px-6">
        <div className="pt-20 sm:pt-28 pb-8 sm:pb-12">
          <div className="text-center mb-8">
            <h1 className="text-3xl sm:text-4xl font-bold text-white mb-2">IDO Platform Registration</h1>
            <p className="text-white/60 text-base sm:text-lg">Complete your IDO platform profile</p>
          </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6 sm:space-y-8">
          ...
          <div className="neo-glass-card rounded-2xl p-4 sm:p-6 border border-white/10">
            <h2 className="text-xl sm:text-2xl font-semibold text-white mb-4 sm:mb-6">Platform Logo *</h2>
            <PNGUploader
          ...
          {/* Company Information */}
          <div className="neo-glass-card rounded-2xl p-4 sm:p-6 border border-white/10">
            <h2 className="text-xl sm:text-2xl font-semibold text-white mb-4 sm:mb-6">Platform Information</h2>
            <div className="space-y-4 sm:space-y-6">
              <div>
                ...
                <input
                  ...
                  placeholder="Your IDO platform's legal name"
                  required
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 rounded-xl bg-white/5 border border-white/10 focus:border-white/30 focus:outline-none text-white placeholder-white/40"
                  placeholder="https://youridoplatform.com"
                  required
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 rounded-xl bg-white/5 border border-white/10 focus:border-white/30 focus:outline-none text-white placeholder-white/40"
                  placeholder="Country where your platform is registered"
                  required
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 rounded-xl bg-white/5 border border-white/10 focus:border-white/30 focus:outline-none text-white placeholder-white/40"
                  placeholder="Brief description of your IDO platform"
                  required
                />
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 rounded-xl bg-white/5 border border-white/10 focus:border-white/30 focus:outline-none text-white placeholder-white/40"
                  placeholder="contact@youridoplatform.com"
                  required
                />
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 rounded-xl bg-white/5 border border-white/10 focus:border-white/30 focus:outline-none text-white placeholder-white/40"
                  placeholder="https://linkedin.com/company/youridoplatform"
                />
              </div>
            </div>
          </div>
