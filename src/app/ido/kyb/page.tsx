...
export default function IDOKYB() {
    ...
    switch (kybStatus) {
      ...
      case 'verified':
        return {
          ...
          title: "KYB Verified",
          description: "Your IDO platform has been successfully verified.",
      ...
      case 'pending':
        return {
          ...
          title: "KYB Pending",
          description: "Your IDO platform verification is being reviewed.",
      ...
      case 'rejected':
        return {
          ...
          title: "KYB Rejected",
          description: "Your IDO platform verification was rejected. Please try again.",
          color: "text-red-400",
      ...
      default:
        return {
          ...
          title: "KYB Required",
          description: "Complete IDO platform verification to access all features.",
          color: "text-blue-400",
        ...
        <div className="w-full max-w-4xl">
          ...
          <div className="text-center mb-8">
            <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">
              IDO Platform Verification
            </h1>
            <p className="text-white/70 text-lg max-w-2xl mx-auto">
              Complete your KYB verification to unlock all IDO platform features and access the full platform
            </p>
          </div>
          ...
          <div className="bg-black/80 backdrop-blur-lg border border-white/20 rounded-3xl shadow-2xl p-8 md:p-12">
            ...
            <div className="bg-gradient-to-r from-blue-500/10 to-blue-500/10 border border-blue-500/30 rounded-2xl p-6 mb-8">
              <div className="flex items-start space-x-4">
                ...
                <div className="flex-1">
                  <h3 className="text-xl font-bold text-white mb-2">AI-Powered IDO Platform Verification</h3>
                  <p className="text-white/70 mb-4">
                    Our AI system verifies your IDO platform information in real-time with advanced company data validation.
                  </p>
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div className="flex items-center space-x-2">
                      <NeonCyanIcon type="check" className="text-green-400" size={20} />
                      <span className="text-white/80 text-sm">Platform Validation</span>
                    </div>
                    <div className="flex items-center space-x-2">
                      <NeonCyanIcon type="check" className="text-green-400" size={20} />
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <input
                      ...
                      placeholder="Enter your IDO platform name"
                    />
                  </div>
            ...
            {isCompleted && (
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <button
                  onClick={() => router.push('/ido/dashboard')}
            ...
            <div className="mt-8 text-center">
              <p className="text-white/50 text-sm">
                Your IDO platform information is encrypted and secure. We never share your data with third parties.
              </p>
            </div>
          </div>
        </div>
