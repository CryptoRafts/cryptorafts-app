# ============================================
# CRYPTORAFTS - DEPLOY HYDRATION FIX
...
Write-Host ""
Write-Host "CRYPTORAFTS - DEPLOY HYDRATION FIX" -ForegroundColor Cyan
...
# Execute rebuild with proper line ending handling
$rebuildCmd = @"
cd $appDir
...
Write-Host ""
if ($LASTEXITCODE -eq 0) {
    Write-Host "SUCCESS: HYDRATION FIX DEPLOYED!" -ForegroundColor Green
    Write-Host "====================================" -ForegroundColor Green
    Write-Host ""
    Write-Host "Your app is now LIVE at:" -ForegroundColor Cyan
    Write-Host " https://www.cryptorafts.com" -ForegroundColor Yellow
    Write-Host ""
    Write-Host "Hydration fix applied:" -ForegroundColor Green
    Write-Host "  - Added suppressHydrationWarning to prevent React error #418" -ForegroundColor Green
    Write-Host "  - Fixed server/client HTML mismatch" -ForegroundColor Green
    Write-Host "  - UI remains unchanged" -ForegroundColor Green
    Write-Host ""
} else {
