...
$SCRIPT_NAME = "FINAL_NGINX_AND_DEPLOYMENT.sh"

Write-Host "==========================================" -ForegroundColor Cyan
Write-Host "FINAL NGINX CONFIGURATION AND DEPLOYMENT" -ForegroundColor Cyan
Write-Host "==========================================" -ForegroundColor Cyan
Write-Host ""
...
Write-Host "Step 2: Running final Nginx configuration and deployment on VPS..." -ForegroundColor Yellow
Write-Host "This will:" -ForegroundColor White
Write-Host "  - Create Nginx configuration file (SSL or HTTP-only)" -ForegroundColor White
Write-Host "  - Link and apply Nginx configuration" -ForegroundColor White
Write-Host "  - Handle SSL errors gracefully (fallback to HTTP)" -ForegroundColor White
...
if ($LASTEXITCODE -eq 0) {
    Write-Host ""
    Write-Host "✅ Final Nginx configuration and deployment completed successfully!" -ForegroundColor Green
    Write-Host ""
    Write-Host "==========================================" -ForegroundColor Cyan
    Write-Host "NEXT STEPS:" -ForegroundColor Cyan
    Write-Host "1. Test website: https://www.cryptorafts.com" -ForegroundColor White
    Write-Host "   (or http://www.cryptorafts.com if SSL not configured)" -ForegroundColor White
