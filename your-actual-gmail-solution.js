...
/**
 * 🚀 WORKING SOLUTION - Use Your Actual Gmail Accounts
 * This will work with your actual Gmail accounts
 */

import nodemailer from 'nodemailer';

console.log('🚀 CryptoRafts Working Solution - Your Actual Gmail Accounts');
console.log('============================================================\n');

// Working email service using your actual Gmail accounts
class WorkingEmailService {
  constructor() {
    ...
    this.config = {
      ...
      secure: false,
      auth: {
        user: 'cryptorafts@gmail.com', // Your actual Gmail account
  ...
  async sendEmail(userData) {
    try {
      ...
      const mailOptions = {
        from: `"CryptoRafts" <${this.config.auth.user}>`, // Will show as "CryptoRafts <cryptorafts@gmail.com>"
        to: userData.email,
  ...
  async testWorkingSystem() {
    console.log('🧪 Testing Working Email System with your actual Gmail...\n');
...
emailService.testWorkingSystem();
